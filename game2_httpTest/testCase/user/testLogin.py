...
login_xls = commonAw.get_xls("userCase.xlsx", "login")
...
class Login(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if info['code'] == 0:
            # get uer token
            token_u = commonAw.get_value_from_return_json(info, 'member', 'token')
    ...
    def checkResult(self):
        ...
        if self.result == '0':
            email = commonAw.get_value_from_return_json(self.info, 'member', 'email')
